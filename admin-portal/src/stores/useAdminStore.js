...
export const useAdminStore = create((set, get) => ({
  ...
  editingPlatformAd: null,
  editPlatformAdForm: { title: '', targetDeviceType: 'all', targetVenueIds: [], durationSeconds: 10, isActive: true },
  isSavingPlatformAd: false,
  ...
  setEditingPlatformAd: (editingPlatformAd) => set({ editingPlatformAd }),
  setEditPlatformAdForm: (editPlatformAdForm) => set({ editPlatformAdForm }),
  setIsSavingPlatformAd: (isSavingPlatformAd) => set({ isSavingPlatformAd }),
